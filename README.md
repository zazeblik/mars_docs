...
# Мультиканальная система обработки запросов

Версия 2.0.1.220416

# Наименование системы

Мультиканальная система обработки запросов MARS (Multi-channel Automatic Response System).

# Установка и запуск MARS
